...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    porcentaje_spread = spread / 100
    tasa_real = exchange_rate * (1 + porcentaje_spread)
    dinero_convertido = budget / tasa_real
    numero_de_billetes = int(dinero_convertido / denomination)
    
    return numero_de_billetes * denomination
